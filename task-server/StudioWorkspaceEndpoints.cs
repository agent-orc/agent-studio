...
/// (plural). Not yet wired into <c>Program.cs</c> - see the group's final
/// report for why - the integrator adds <c>app.MapStudioWorkspaceEndpoints()</c>
/// once every P1 group has landed.
/// </summary>
