...
/// stored, at the HTTP boundary. <c>Program.cs</c> now maps
/// <c>MapStudioTaskArtifactsEndpoints</c> and runs
/// <c>ApplyStudioTaskArtifactsMigrationAsync</c> as part of the shared
