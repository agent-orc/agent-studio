...
public sealed class ScenarioTests
{
    ...
    {
        var target = Environment.GetEnvironmentVariable("SCENARIO_TARGET") ?? "inproc";
        ...
        using var context = await ScenarioContext.CreateAsync(root, fixture, target);
        ...
        var junitPath = ScenarioReportWriter.WriteJUnit(result, target, reportDirectory);
        var markdownPath = ScenarioReportWriter.WriteMarkdown(result, target, reportDirectory);
