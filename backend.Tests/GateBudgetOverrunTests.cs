...
public sealed class GateBudgetOverrunTests
{
    ...
    [InlineData("Failed Product.Tests.Red [12 ms]", BuildTestGateFailureKind.Code)]
    [InlineData("[xUnit.net 00:00:01] Product.Tests.Red [FAIL]", BuildTestGateFailureKind.Code)]
    [InlineData(" FAIL  src/red.spec.ts > fails", BuildTestGateFailureKind.Code)]
    [InlineData(" × fails 12ms", BuildTestGateFailureKind.Code)]
