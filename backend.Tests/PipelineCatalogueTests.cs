...
public class PipelineCatalogueTests
{
    ...
    public void ReadOnlyPipeline_IsLightweightAndOmitsCodeGates()
    {
        ...
        Assert.Equal(
            [PipelineCatalogue.SummaryStepId, PipelineCatalogue.OrchestratorReviewStepId, PipelineCatalogue.OrchestratorDecisionStepId],
    ...
    public void ConceptPipeline_IsDocumentReviewThenSightGateThenPromotion()
    {
        ...
        Assert.Equal(
            [
                ...
                PipelineCatalogue.SummaryStepId,
