...
{
    [Fact]
    public void Inventory_is_the_approved_100_local_and_308_proxy_surface()
    {
        ...
        Assert.Equal(100, inventory.DevSeatOperations.Count);
        Assert.Equal(308, inventory.TaskServerOperations.Count);
