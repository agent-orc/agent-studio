...
| Global Watcher operator setup: kill switch, sweep cadence, detector thresholds, the dedicated contingent, and the proposal review mode (AGT-2721) | [setup guide](../operations/setup/global-watcher.md) |
