...
| Global search stalls on one repository with a large history or working tree (AGT-2723) | [common-problems/global-search-slow-repository/](../operations/common-problems/global-search-slow-repository/) |
