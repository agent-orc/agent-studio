...
| Global Watcher operation (kill switch, contingent, detector thresholds, proposal review) | [operations/setup/global-watcher.md](../operations/setup/global-watcher.md) |
