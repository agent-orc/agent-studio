...
| Background git state index (board state as a background index, freshness stamp, spawn budget, Admin performance panel; AGT-2726) | [reports/git-state-index-agt-2726.md](../system/reports/git-state-index-agt-2726.md) |
