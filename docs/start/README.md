...
| Decision cards (first-class `kind: decision`, options + choose CTA, ADR-style record, dependant unblocking; AGT-2795) | [concepts/decision-cards.md](../concepts/decision-cards.md) |
