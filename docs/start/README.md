...
| Git-derived board state as a background index; request paths never spawn or wait on git (AGT-2726) | [contracts/git-state-index.md](../system/contracts/git-state-index.md) |
