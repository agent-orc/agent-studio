...
| Task and board UI decisions: the consolidated Dossier for task detail and board chrome, with the decided usage block, protocol condensation and status.md contracts and five open choices carried over from AGT-W17, W20, W21, W27, W35, W45, W48 and W52 (AGT-2802) | [decision dossier](../operations/task-and-board-ui/index.html) |
...
| Background per-repository Git state index: change-driven indexing, gitStateAt/stale wire contract, Admin telemetry (AGT-2726) | [reports/git-state-index-agt-2726.md](../system/reports/git-state-index-agt-2726.md) |
...
| Single-host Task Server daily operation after the AGT-2737 rehearsal: health, backup verification, update, rollback, and the shared-host limit | [operations/setup/single-host-task-server-operator-runbook.md](../operations/setup/single-host-task-server-operator-runbook.md) |
