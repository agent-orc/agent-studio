...
| Global search stalls on a repository with a long history (AGT-2723) | [common-problems/slow-global-search-on-large-repository/](../operations/common-problems/slow-global-search-on-large-repository/) |
