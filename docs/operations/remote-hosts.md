...
capability heartbeat. Execution Hosts shows the Stable version this server runs
next to the machine and role counts, and each role row carries its own release
...
is an offline problem and does not alarm for drift. Set
