...
| [remote-runner-persistent-connection.md](./remote-runner-persistent-connection.md) | Task Server-owned SSH reverse link, heartbeat and recovery checks, seven-day migration acceptance, and the disabled Scheduled Task emergency path. |
