...
| [single-host-task-server.md](./single-host-task-server.md) | Daily health, backup verification, update, and rollback for the approved interim single-host Task Server topology. |
