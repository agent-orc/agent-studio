...
| [global-watcher.md](./global-watcher.md) | Configure the Global Watcher: the `Watcher:Enabled` kill switch, sweep cadence, detector thresholds, the dedicated per-day/per-week contingent, and the review mode that answers ticket proposals. |
