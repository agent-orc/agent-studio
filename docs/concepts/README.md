...
| [decision-cards.md](decision-cards.md) | The first-class `kind: decision` card (AGT-2795): structured options with consequences/effort/risks, a recommendation, the decider, the choose-with-rationale CTA, the ADR-style record, and how a decision unblocks or seeds its dependant implementation cards. | [`docs/system/domains/tasks.md`](../system/domains/tasks.md), [`docs/concepts/task-integration-and-merge-workflow.md`](task-integration-and-merge-workflow.md) |
