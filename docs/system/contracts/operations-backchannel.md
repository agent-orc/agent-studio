...
before polling new work. Rejected or stale evidence remains on disk and stops
that agent from taking more work until reconciled. This deliberately does not
