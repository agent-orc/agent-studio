...
- `frontend/src/app/features/project-detail/`: project shell and project-level
  ...
  browser preferences. Graph commits include body, committer identity/time, and
  an attributed run id when task metadata carries one; no details action mutates
  the repository.
