...
public static class LeaseEndpoints
{
    ...
    public static void MapLeaseEndpoints(this WebApplication app)
    {
            ...
            TaskMutationService mutations) =>
        {
            ...
            if (!string.IsNullOrWhiteSpace(req.StartedPromptSha256))
            {
                ...
                var acknowledged = mutations.AcknowledgeStashedPendingIntent(
                    task.FolderPath,
            ...
            CancellationToken ct) =>
        {
            ...
            try
            {
                ...
                runSpec = AddStashedFollowUp(runSpec, stashedIntent);
                MoveJobOutcome move;
                try
                {
    ...
    private static RunSpecDto AddStashedFollowUp(RunSpecDto runSpec, PendingIntent? intent)
        => intent is null
            ? runSpec
            : runSpec with
            {
