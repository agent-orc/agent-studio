...
/// <summary>
/// Route information exposed while the broker still owns an unclaimed item.
/// Claim admission can reject one candidate without consuming it and continue
/// scanning work that the same runner is able to execute.
/// </summary>
