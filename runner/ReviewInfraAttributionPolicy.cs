...
internal enum ReviewInfraAttribution
{
    /// <summary>
...
/// </summary>
internal static class ReviewInfraAttributionPolicy
{
    ...
    internal static ReviewInfraAttribution Attribute(ProcessResult process)
        => Attribute(process.Success, process.StdOut, process.StdErr);

    internal static ReviewInfraAttribution Attribute(
        bool commandSucceeded,
        string standardOutput,
        string standardError)
    {
        if (commandSucceeded) return ReviewInfraAttribution.ProductOwned;
        ...
        if (evidence.ReportsFailedTests) return ReviewInfraAttribution.ProductOwned;
