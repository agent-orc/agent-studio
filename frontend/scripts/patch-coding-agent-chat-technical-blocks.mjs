 ...
 * but 0.4.1 still sends unfenced CLI diffs and raw markup through the complete
 * GFM pipeline. Protect those conservative technical shapes before Marked sees
