...
import { WatcherContingentPanelComponent } from '../../../watcher';
...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, CliModelsPanelComponent, CliContractsPanelComponent, WatcherContingentPanelComponent],
