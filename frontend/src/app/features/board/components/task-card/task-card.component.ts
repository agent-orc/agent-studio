...
import { ProviderSignInDialogService, ProviderAuthStatusService, providerAuthWaitReason } from '../../../remote-hosts';
...
export class TaskCardComponent implements OnInit, OnDestroy {
  ...
  private readonly providerAuthStatus = inject(ProviderAuthStatusService); readonly providerSignIn = inject(ProviderSignInDialogService);
