...
function step(overrides: Partial<PipelineAdminRow>): PipelineAdminRow {
  return {
    ...
    cliType: '', model: '', thinkingLevel: '', configuredCliType: '', configuredModel: '',
    configuredThinkingLevel: '', effectiveCliType: '', effectiveModel: '',
    effectiveModelSource: '', effectiveThinkingLevel: '', quotaAdmission: null,
    effectiveRouteChanged: false, prompt: '', promptTemplate: '', mode: '',
