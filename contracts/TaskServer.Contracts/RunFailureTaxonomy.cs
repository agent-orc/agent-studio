...
public static class RunFailureClassifier
{
    ...
    /// <summary>
    /// The placeholder the remote review executor used to synthesize when a
    /// verify command failed without a parsable test result. It must never be
    /// counted as a failing test.
    /// </summary>
